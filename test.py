...
def get_jwt_token():
    global jwt_token
    url = "https://jwt-sigma-teal.vercel.app/api/oauth_guest?uid=4091130573&password=42DF3E9AAF63C943BF110980F43DBC69073A6DAAC2A6739CCA8FBDEC46689A0B"
    try:
        response = httpx.get(url)
        response.raise_for_status()  # يتحقق من نجاح الطلب
        data = response.json()
        # هنا نأخذ التوكن مباشرة
        ...
        if jwt_token:
            ...
            logging.error("Failed to get JWT token from response.")
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Làm Bot Thì Viết Code Bot Gọi Hàm Chạy Lệnh Này: python test.py uid-cần-mời số-team")
        sys.exit(1)
    try:
    ...
    try:
        client_thread = FF_CLIENT(
            id="4091130573",
            password="42DF3E9AAF63C943BF110980F43DBC69073A6DAAC2A6739CCA8FBDEC46689A0B",
